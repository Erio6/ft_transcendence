    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    ...
                    models.ForeignKey(
                        on_delete=django.db.models.deletion.CASCADE,
                        related_name="tournament_game_looser",
                        to="user.userprofile",
                    ),
                ),
                (
                    ...
                    models.ForeignKey(
                        on_delete=django.db.models.deletion.CASCADE,
                        related_name="tournament_player_one",
                        to="user.userprofile",
                    ),
                ),
                (
                    ...
                    models.ForeignKey(
                        on_delete=django.db.models.deletion.CASCADE,
                        related_name="tournament_player_two",
                        to="user.userprofile",
                    ),
                ),
                (
                ...
                (
                    ...
                    models.ForeignKey(
                        on_delete=django.db.models.deletion.CASCADE,
                        related_name="tournament_game_winner",
                        to="user.userprofile",
                    ),
                ),
            ],
        ...
        migrations.AddField(
            ...
            field=models.ManyToManyField(
                through="tournaments.TournamentPlayer", to="tournaments.tournament"
            ),
        ),
    ]
